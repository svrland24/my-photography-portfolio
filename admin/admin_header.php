...
<div class="admin-layout">
    ...
    <aside class="admin-sidebar">
        ...
        <ul class="admin-menu">
            ...
            <li>
                <a href="photos.php" class="<?php echo in_array($current_page, ['photos.php', 'edit_photo.php']) ? 'active' : ''; ?>">
        ...
        <div style="margin-top: auto; padding-top: 1.5rem; border-top: 1px solid var(--border-color);">
            ...
            <a href="logout.php" class="btn-admin" style="width: 100%; justify-content: center; background: rgba(239, 68, 68, 0.2); border: 1px solid #ef4444; color: #f87171; box-shadow: none;">
